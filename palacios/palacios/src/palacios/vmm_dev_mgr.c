...
int V3_init_devices() {
	...
	extern int nvram_init(struct v3_vm_info *, v3_cfg_tree_t *);
	__start__v3_devices[0].name = "LAPIC";
	__start__v3_devices[0].init = apic_init;
	__start__v3_devices[1].name = "IOAPIC";
	__start__v3_devices[1].init = ioapic_init;
	__start__v3_devices[2].name = "MPTABLE";
	__start__v3_devices[2].init = mptable_init;
	__start__v3_devices[3].name = "8254_PIT";
	__start__v3_devices[3].init = pit_init;
	__start__v3_devices[4].name = "8259A";
	__start__v3_devices[4].init = palacios_pic_init;
	__start__v3_devices[5].name = "BOCHS_DEBUG";
	__start__v3_devices[5].init = bochsdebug_init;
	__start__v3_devices[6].name = "GENERIC";
	__start__v3_devices[6].init = generic_init;
	__start__v3_devices[7].name = "i440FX";
	__start__v3_devices[7].init = i440_init;
	__start__v3_devices[8].name = "IDE";
	__start__v3_devices[8].init = palacios_ide_init;
	__start__v3_devices[9].name = "SERIAL";
	__start__v3_devices[9].init = serial_init;
	__start__v3_devices[10].name = "KEYBOARD";
	__start__v3_devices[10].init = keyboard_init;
	__start__v3_devices[11].name = "LNX_VIRTIO_BALLOON";
	__start__v3_devices[11].init = balloonvirtio_init;
	__start__v3_devices[12].name = "LNX_VIRTIO_BLK";
	__start__v3_devices[12].init = blkvirtio_init;
	__start__v3_devices[13].name = "NVRAM";
	__start__v3_devices[13].init = nvram_init;
	__start__v3_devices[14].name = "OS_DEBUG";
	__start__v3_devices[14].init = osdebug_init;
	__start__v3_devices[15].name = "PCI";
	__start__v3_devices[15].init = pci_init;
	__start__v3_devices[16].name = "PIIX3";
	__start__v3_devices[16].init = piix3_init;
	__start__v3_devices[17].name = "DISK_MODEL";
	__start__v3_devices[17].init = model_init;
	__start__v3_devices[18].name = "TMPDISK";
	__start__v3_devices[18].init = tmpdisk_init;
	__start__v3_devices[19].name = "RAMDISK";
	__start__v3_devices[19].init = ramdisk_init;
...
#endif
    PrintDebug("Start addres=0x%p, Stop address=0x%p, each_dev_size=0x%lx\n", __start__v3_devices, __stop__v3_devices, sizeof(struct v3_device_info));
    master_dev_table = v3_create_htable(0, dev_hash_fn, dev_eq_fn);
	V3_Print("master_dev_table = %p\n", master_dev_table);

    while (tmp_dev != __stop__v3_devices) {
		PrintDebug("Device: %s, at %p\n", tmp_dev->name, tmp_dev->init);
