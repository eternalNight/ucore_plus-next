...
extern int pit_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int palacios_pic_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int apic_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int bochsdebug_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int cga_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int stream_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int cirrus_gfx_card_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int cons_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int model_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int filedisk_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int generic_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int i440_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int palacios_ide_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int ioapic_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int keyboard_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int balloonvirtio_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int blkvirtio_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int convirtio_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int nicvirtio_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int symvirtio_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int symmodvirtio_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int dev_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int mptable_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int ne2k_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int netdisk_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int nic_bridge_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int nvram_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int osdebug_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int net_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int pci_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int pci_front_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int passthrough_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int piix3_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int ramdisk_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int rtl8139_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int serial_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int simplepic_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int swap_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int swap2_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int cons_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int timer_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int tmpdisk_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int vga_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
extern int vnet_nic_init(struct v3_vm_info * vm, v3_cfg_tree_t * cfg);
