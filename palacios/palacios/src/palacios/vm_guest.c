...
int v3_init_vm(struct v3_vm_info * vm) {
	...
	V3_Print(">> v3_init_vm >> 08\n");
    v3_init_time_vm(vm);
	V3_Print(">> v3_init_vm >> 09\n");

#ifdef V3_CONFIG_SYMBIOTIC
    v3_init_symbiotic_vm(vm);
#endif
	V3_Print(">> v3_init_vm >> 10\n");
    v3_init_dev_mgr(vm);
	V3_Print(">> v3_init_vm >> 11\n");
